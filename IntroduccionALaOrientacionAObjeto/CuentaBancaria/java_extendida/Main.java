...
public class Main {
    public static void main(String args[]){
        ...
        System.out.println();
        System.out.println("Registro de Alice:");
        for(String movimiento : cuentaDeAlice.getHistoricoDeMovimientos()){
            System.out.println(movimiento);
        }
        System.out.println();
        System.out.println("Registro de Bob:");
        for(String movimiento : cuentaDeBob.getHistoricoDeMovimientos()){
            System.out.println(movimiento);
        }
